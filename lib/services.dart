...
class Weather with ChangeNotifier{
  ...
  Future locCurrentWeather() async {
    url = "https://api.weatherbit.io/v2.0/current?lat=$lat&lon=$lon&key=$apiKey";
  ...
  Future currentWeather() async {
    var canadaCurrentUrl = "https://api.weatherbit.io/v2.0/forecast/daily?city=${cityName.text}&country=CA&key=$apiKey";
    var currentUrl = "https://api.weatherbit.io/v2.0/current?city=${cityName.text}&key=$apiKey";
    url = cityName.text == "Montreal" || cityName.text == "Montréal" || cityName.
  ...
  Future forecastWeather() async {
    var canadaForecastUrl = "https://api.weatherbit.io/v2.0/forecast/daily?city=${cityName.text}&country=CA&key=$apiKey";
    var forecastUrl = "https://api.weatherbit.io/v2.0/forecast/daily?city=${cityName.text}&key=$apiKey";
    url = cityName.text == "Montreal" || cityName.text == "Montréal" || cityName.
