...
class _GetLocationState extends State<GetLocationWidget> {
  ...
  Future current() async {
    ...
    var locweather1 = jsonDecode(response1.body);
    setState(() {

      this.icon=locweather1['data'][0]['weather']['icon'];
      this.temp=locweather1['data'][0]['temp'];
      this.main=locweather1['data'][0]['weather']['description'];
      this.wind=locweather1['data'][0]['wind_spd'];
      this.code=locweather1['data'][0]['weather']['code'];
  ...
  Future locWeather() async {
    ...
    var locweather = jsonDecode(response.body);
      setState(() {
        this.city=locweather['city_name'];
        this.temp1=locweather['data'][1]['temp'];
        this.temp2=locweather['data'][2]['temp'];
        this.temp3=locweather['data'][3]['temp'];
        this.temp4=locweather['data'][4]['temp'];
        this.temp5=locweather['data'][5]['temp'];
        this.temp6=locweather['data'][6]['temp'];
        this.main1=locweather['data'][1]['weather']['description'];
        this.main2=locweather['data'][2]['weather']['description'];
        this.main3=locweather['data'][3]['weather']['description'];
        this.main4=locweather['data'][4]['weather']['description'];
        this.main5=locweather['data'][5]['weather']['description'];
        this.main6=locweather['data'][6]['weather']['description'];
        this.mintemp=locweather['data'][0]['min_temp'];
        this.maxtemp=locweather['data'][0]['max_temp'];
        this.icon1=locweather['data'][1]['weather']['icon'];
        this.icon2=locweather['data'][2]['weather']['icon'];
        this.icon3=locweather['data'][3]['weather']['icon'];
        this.icon4=locweather['data'][4]['weather']['icon'];
        this.icon5=locweather['data'][5]['weather']['icon'];
        this.icon6=locweather['data'][6]['weather']['icon'];
        this.date1=locweather['data'][1]['datetime'];
        this.date2=locweather['data'][2]['datetime'];
        this.date3=locweather['data'][3]['datetime'];
        this.date4=locweather['data'][4]['datetime'];
        this.date5=locweather['data'][5]['datetime'];
        this.date6=locweather['data'][6]['datetime'];
      });
      refreshController.refreshCompleted();
...
@override
  void initState() {
    ...
    super.initState();
    loc().then((value) => current().then((value) => locWeather()));
  }
